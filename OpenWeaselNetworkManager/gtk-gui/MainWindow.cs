...
public partial class MainWindow
{
	...
	private global::Gtk.Action CheckForUpdateAction;
	private global::Gtk.Action AboutAction;
	private global::Gtk.Action ExitAction;
	private global::Gtk.ToggleAction TerminalAction;
	...
	protected virtual void Build ()
	{
		...
		this.CheckForUpdateAction = new global::Gtk.Action ("CheckForUpdateAction", global::Mono.Unix.Catalog.GetString ("Check for Update"), null, null);
		this.CheckForUpdateAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Check for Update");
		w1.Add (this.CheckForUpdateAction, null);
		...
		this.TerminalAction = new global::Gtk.ToggleAction ("TerminalAction", global::Mono.Unix.Catalog.GetString ("Terminal"), null, null);
		this.TerminalAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Terminal");
		w1.Add (this.TerminalAction, null);
		...
		w27.Y = 22;
		// Container child fixed1.Gtk.Fixed+FixedChild
		this.UIManager.AddUiFromString ("<ui><menubar name='MenuBar'><menu name='FileAction' action='FileAction'><menuitem name='SaveAction' action='SaveAction'/><menuitem name='CheckForUpdateAction' action='CheckForUpdateAction'/><menuitem name='AboutAction' action='AboutAction'/><menuitem name='ExitAction' action='ExitAction'/></menu><menu name='ViewAction' action='ViewAction'><menuitem name='TerminalAction' action='TerminalAction'/></menu><menu name='HelpAction' action='HelpAction'><menuitem name='SupportAction' action='SupportAction'/></menu></menubar></ui>");
